...
# ------------------------------------------------------------
# Hyperparameters - Full model (10.8M params) tuned for GPU
# ------------------------------------------------------------
batch_size = 64
block_size = 256
max_iters = 6000           # Good quality on GPU in ~30-60 min (depending on GPU)
eval_interval = 500
learning_rate = 3e-4
...
# ------------------------------------------------------------
# Data: download Tiny Shakespeare if not present
# ------------------------------------------------------------
...
print("\n============================================================")
print("NanoGPT Training (GPU-ready)")
print("============================================================")
...
for iter in range(max_iters):
    ...
    # Lightweight heartbeat every 100 steps
